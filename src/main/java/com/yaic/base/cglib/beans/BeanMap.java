...
public abstract class BeanMap implements Map
{
	...
	public static class Generator extends AbstractClassGenerator
	{
		 ...
		 *
		 * @param require
		 *           any combination of {@link #REQUIRE_GETTER} and {@link #REQUIRE_SETTER}; default is zero (any property
		 *           allowed)
		 */
	...
	/**
	 * Create a new <code>BeanMap</code> instance using the specified bean. This is faster than using the {@link #create}
	 * static method.
	 *
	 * @param bean
	 *           the JavaBean underlying the map
	...
	public Set entrySet()
	{
		final HashMap<Object, Object> copy = new HashMap<>();
		for (final Iterator it = keySet().iterator(); it.hasNext();)
		{
			final Object key = it.next();
