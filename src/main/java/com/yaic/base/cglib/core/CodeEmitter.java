...
import com.yaic.base.asm.Attribute;
import com.yaic.base.asm.Label;
import com.yaic.base.asm.LocalVariablesSorter;
...
public class CodeEmitter extends LocalVariablesSorter
{
	 ...
	 *
	 */
	public final int ADD = Constants.IADD;
	/**
	 *
	 */
	public final int MUL = Constants.IMUL;
	/**
	 *
	 */
	public final int XOR = Constants.IXOR;
	/**
	 *
	 */
	public final int USHR = Constants.IUSHR;
	/**
	 *
	 */
	public final int SUB = Constants.ISUB;
	/**
	 *
	 */
	public final int DIV = Constants.IDIV;
	/**
	 *
	 */
	public final int NEG = Constants.INEG;
	/**
	 *
	 */
	public final int REM = Constants.IREM;
	/**
	 *
	 */
	public final int AND = Constants.IAND;
	/**
	 *
	 */
	public final int OR = Constants.IOR;

	/**
	 *
	 */
	public final int GT = Constants.IFGT;
	/**
	 *
	 */
	public final int LT = Constants.IFLT;
	/**
	 *
	 */
	public final int GE = Constants.IFGE;
	/**
	 *
	 */
	public final int LE = Constants.IFLE;
	/**
	 *
	 */
	public final int NE = Constants.IFNE;
	/**
	 *
	 */
	public final int EQ = Constants.IFEQ;
	...
	/**
	 * @return the ClassEmitter instance
	 */
	...
	public void getfield(final String name)
	{
		...
		final int opcode = TypeUtils.isStatic(info.access) ? Constants.GETSTATIC : Constants.GETFIELD;
	...
	{
		final ClassEmitter.FieldInfo info = ce.getFieldInfo(name);
		final int opcode = TypeUtils.isStatic(info.access) ? Constants.PUTSTATIC : Constants.PUTFIELD;
		emit_field(opcode, ce.getClassType(), name, info.type);
	}
	...
	public void box(final Type type)
	{
		if (TypeUtils.isPrimitive(type))
		{
			...
			else
			{
				...
				invoke_constructor(boxed, new Signature(Constants.CONSTRUCTOR_NAME, Type.VOID_TYPE, new Type[]
				{ type }));
			}
		}
	}
	...
	/**
	 * Allocates and fills an Object[] array with the arguments to the current method. Primitive values are inserted as
	 * their boxed (Object) equivalents.
	 */
