...
public class TypeUtils
{
	...
	/**
	 * @param access
	 * @return true if value if static
	 */
	...
	/**
	 * @param access
	 * @return true if value if protected
	 */
	...
	/**
	 * @param access
	 * @return true if value if public
	 */
	...
	/**
	 * @param access
	 * @return true if value if abstract
	 */
	...
	/**
	 * @param access
	 * @return true if value if interface
	 */
	...
	/**
	 * @param access
	 * @return true if value if private
	 */
	...
	/**
	 * @param access
	 * @return true if value if synthetic
	 */
	...
	/**
	 * @param access
	 * @return true if value if bridge
	 */
	...
	/**
	 * @param s
	 * @return string with upper first
	 */
	...
	{
		final List<String> types = new ArrayList<>(5);
		for (;;)
		{
	...
	private static String map(String type)
	{
		...
		final String t = transforms.get(type);
		if (t != null)
		{
			return t;
		}
	...
	{
		for (final Entry<String, String> entry : transforms.entrySet())
		{
			rtransforms.put(entry.getValue(), entry.getKey());
		}
	}
}
