package com.yaic.commons.io.output;
...
import com.yaic.commons.io.input.ClosedInputStream;
 ...
 * <p>
 * Closing a {@code ByteArrayOutputStream} has no effect. The methods in this class can be called after the stream has
...
public class ByteArrayOutputStream extends OutputStream
{
	...
	/**
	 * Writes the entire contents of the specified input stream to this byte stream. Bytes from the input stream are read
	 * directly into the internal buffers of this streams.
	 *
	 * @param in
	...
	/**
	 * Closing a {@code ByteArrayOutputStream} has no effect. The methods in this class can be called after the stream
